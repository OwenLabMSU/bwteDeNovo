---
title: "Shed Level Early Infection - Bursa - Transcript"
...
This is an analysis of differential expression at the transcript level between low, moderate, and high LPAIV shedding blue-winged teals based on cloacal swab virus titers measured on the day of sacrifice for bursa samples on 1 and 3 days post infection (DPI).
...
```{r, eval = FALSE, warning = FALSE, message = FALSE, fig.height = 7, fig.width = 8, fig.align = "center"}
