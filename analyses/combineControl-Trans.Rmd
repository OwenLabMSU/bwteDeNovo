---
title: "Combine control groups - Transcript"
...
This analysis asks whether it is appropriate to combine the day 1 and day 14 control groups for the analysis between LPAIV-infected and uninfected control blue-winged teals. This is for the transcript-level data.
...
annot %>%
  ...
  select(transcript, SwissProt_GeneName, Kegg) %>% 
  kbl(booktabs = TRUE, 
      longtable =T,
